...
<video width="100%" controls preload="metadata" aria-label="SIA Health application demo walkthrough video" title="SIA Health Demo - Dashboard Navigation and Quality Checks">
  <source src="./assets/siaHealth.mp4" type="video/mp4">
  Your browser does not support the video tag. You can <a href="./assets/siaHealth.mp4">download the video here</a>.
</video>
